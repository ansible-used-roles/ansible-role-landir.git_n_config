...
sudo env PATH=$PATH ansible-pull -U https://github.com/ansible-used-roles/ansible-role-landir.git_n_config -d /etc/ansible/roles/ansible-role-landir.git_n_config -i scripts/localinventory default.yml
